...
import { SigninInput } from "@rryu/medium-common";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" type={"string"} placeholder="Ryu .." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} />: null}
                    <LabelledInput label="Username" type={"string"} placeholder="ryu@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
